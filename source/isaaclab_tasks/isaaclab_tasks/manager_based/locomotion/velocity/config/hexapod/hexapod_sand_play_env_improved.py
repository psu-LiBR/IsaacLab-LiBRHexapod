...
from .sand_env_improved_cfg import HexapodSandImprovedEnvCfg_PLAY


class HexapodSandImprovedPlayEnv(ManagerBasedRLEnv):
    def __init__(self, cfg: HexapodSandImprovedEnvCfg_PLAY, render_mode=None, **kwargs):
        print("[DEBUG]: Entering HexapodSandImprovedPlayEnv __init__")
        ...
        print("[DEBUG]: HexapodSandImprovedPlayEnv __init__ completed")
    ...
    def _apply_rft(self):
        ...
        if self._debug_print_count % 50 == 0:
            ...
            print(
                f"[DEBUG]: step={self._debug_print_count} "
