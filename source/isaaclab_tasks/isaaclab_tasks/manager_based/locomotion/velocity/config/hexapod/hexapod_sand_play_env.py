...
from .sand_env_cfg import HexapodSandEnvCfg_PLAY


class HexapodSandPlayEnv(ManagerBasedRLEnv):
    def __init__(self, cfg: HexapodSandEnvCfg_PLAY, render_mode=None, **kwargs):
        print("[DEBUG]: Entering HexapodSandPlayEnv __init__")
        ...
        print("[DEBUG]: HexapodSandPlayEnv __init__ completed")
