...
"""Replay a trained discrete (DQN/DDQN) checkpoint on the binary hexapod env and record video.
...
# closeup camera: track env 0's robot root instead of the wide fixed view
env_cfg.viewer.origin_type = "asset_root"
env_cfg.viewer.asset_name = "robot"
env_cfg.viewer.env_index = 0
env_cfg.viewer.eye = (1.6, 1.6, 1.0)
